...
div().appendTo(formDiv).size('150px', '40px').marginLeft('100px').marginTop('75px').color('blue').borderRadius(5).boxShadow('5px 5px 5px black')
...
div().appendTo(formDiv).size('150px', '40px').marginLeft('10px').marginTop('75px').color('green').borderRadius(5).boxShadow('5px 5px 5px black')
...
div().appendTo(formDiv).size('150px', '40px').marginLeft('10px').marginTop('75px').color('red').borderRadius(5).boxShadow('5px 5px 5px black')
...
div().appendTo(formDiv).size('150px', '40px').marginLeft('10px').marginTop('75px').color('violet').borderRadius(5).boxShadow('5px 5px 5px black')

...
requirejs(['bloglist', 'blogwriter','telegram'], function (bloglist,blogwrite, tele) {
    ...
    var teleWrapper = div().append().border('4px solid gray').position('absolute').top(80).left(30);

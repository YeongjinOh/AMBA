...
div().appendTo(form).displayBlock().size('240px', '60px').margin('auto').color('#4c00e6').text('AMBA').fontSize('50px')
    .fontBold().fontColor('white').textAlignCenter().textDragNone().cursorDefault();

div().appendTo(form).displayBlock().size('270px', '20px').margin('auto').marginTop('20px').color('#4c00e6').text('Email')
    .fontSize('15px').fontColor('white').textDragNone().cursorDefault();
...
div().appendTo(form).displayBlock().size('50px', '20px').float('right').marginRight('15px').marginTop('10px').textAlignRight()
    .color('#4c00e6').text('Sign Up').fontSize('13px').fontColor('white').fontBold().textDragNone().cursorPointer().hover(function (dv) {
    dv.fontColor('black');
},  function (dv) {
    dv.fontColor('white');
}).click( function () {
